...
for train_index,test_index in kf.split(input_ids,labels,attention_masks):
    ...
    #model
    fitted = model.fit([input_ids_tr,attention_masks_tr],labels_tr,batch_size=32,epochs=100,callbacks=callbacks)
