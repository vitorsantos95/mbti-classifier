...
dataset_t1 = pd.read_csv("../../../data_set/defesa/t2_defesa.csv", sep='\t')
dataset_t1 = dataset_t1.drop(['Unnamed: 0'], axis=1)
print(dataset_t1.head())

print(dataset_t1.groupby('type_2').count())
...
print(x_final.shape)
print(dataset_t1['type_2'].shape)

import pickle
print("STARTING PICKLE")
model = clf_t1
x_model = x_final
y_model = dataset_t1['type_2']
model.fit(x_model, y_model)
filename = 'logistic_regression_t2_2_6.sav'
