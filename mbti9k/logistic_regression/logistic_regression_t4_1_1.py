...
dataset_t1 = pd.read_csv("../../../data_set/defesa/t4_defesa.csv", sep='\t')
dataset_t1 = dataset_t1.drop(['Unnamed: 0'], axis=1)
print(dataset_t1.head())

print(dataset_t1.groupby('type_4').count())
...
print(x_final.shape)
print(dataset_t1['type_4'].shape)

import pickle
print("STARTING PICKLE")
model = clf_t1
x_model = x_final
y_model = dataset_t1['type_4']
model.fit(x_model, y_model)
filename = 'logistic_regression_t4_1_1.sav'
