...
dataset = pd.read_csv("../../../../../data_set/defesa/t4_defesa_twisty_fr.csv", sep=';', encoding='ISO-8859-1')
print(dataset.head())
print(Counter(dataset['jp']))
...
for train_index,test_index in kf.split(input_ids,labels,attention_masks):
    ...
    #model
    fitted = model.fit([input_ids_tr,attention_masks_tr],labels_tr,batch_size=32,epochs=10,callbacks=callbacks)
