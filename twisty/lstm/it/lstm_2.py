...
dataset = pd.read_csv("../../../../data_set/defesa/t2_defesa_twisty_it.csv", sep=';', encoding='ISO-8859-1')
print(dataset.head())
...
nlp.wv.save_word2vec_format('lstm_2.bin', binary=True)
...
model_bkp.save('lstm_2_model.h5')
model_bkp.save_weights('lstm_2_weights.h5')
