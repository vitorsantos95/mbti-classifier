...
dataset = pd.read_csv("../../../../data_set/defesa/t3_defesa_twisty_it.csv", sep=';', encoding='ISO-8859-1')
print(dataset.head())
...
lst_stopwords = nltk.corpus.stopwords.words("italian")
...
nlp.wv.save_word2vec_format('lstm_3.bin', binary=True)
...
model_bkp.save('lstm_3_model.h5')
model_bkp.save_weights('lstm_3_weights.h5')
