...
dataset = pd.read_csv("../../../../data_set/defesa/t4_defesa_twisty_it.csv", sep=';', encoding='ISO-8859-1')
print(dataset.head())
...
nlp.wv.save_word2vec_format('lstm_4.bin', binary=True)
...
model_bkp.save('lstm_4_model.h5')
model_bkp.save_weights('lstm_4_weights.h5')
